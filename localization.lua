...
WIM_L_CLASSCOLORMESSAGES="Class color message names.";
WIM_L_CLASSCOLORMESSAGESTOOLTIP="When enabled, player names in messages and history use class colors.";
...
WIM_L_ESCAPEUNFOCUS="Use escape to leave window focus and keep text.";
WIM_L_ESCAPEUNFOCUSTOOLTIP="When enabled, pressing Escape will\nremove focus from the message box\nbut keep the text. The window stays open.";
WIM_L_CLICKUNFOCUS="Click outside to unfocus editbox.";
WIM_L_CLICKUNFOCUSTOOLTIP="When enabled, clicking outside the window\nwill remove focus from the message box.";
...
WIM_L_ESCTOCLOSEWINDOWS="Use escape to close windows.";
...
WIM_L_TABBARBELOW="Display tab bar below WIM.";
WIM_L_TABBARBELOWTOOLTIP="Only applies when windows are merged.";
WIM_L_PFUI_FOCUS_WINDOW_BORDER_CLASS="pfUI: Class-color merged window border on focus.";
WIM_L_PFUI_FOCUS_WINDOW_BORDER_CLASSTOOLTIP="When enabled with pfUI WIM integration, the merged WIM window border uses the recipient's class color while the editbox is focused.";
WIM_L_WIMCACHE_LOOKUP="Use WIM player cache fallback.";
WIM_L_WIMCACHE_LOOKUPTOOLTIP="When enabled, WIM uses cached class/level/guild data from its own saved player cache before live /who data arrives.";
WIM_L_PFUI_LOOKUP="Use pfUI player cache fallback.";
...
WIM_L_MERGEWINDOWS="Merge windows into a single tabbed frame";
WIM_L_UP="Up";
WIM_L_DOWN="Down";
WIM_L_LEFT="Left";
WIM_L_RIGHT="Right";
